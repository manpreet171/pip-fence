...
// Run: node heritage/evals/judge_eval.mjs
import { readFileSync } from "node:fs";
import { IDS, redact, phrase, parseWordlist, PROVIDERS } from "../src/buddy.mjs";
...
const ids = IDS.filter(id => id !== "correct" && id !== "ambiguous" && id !== "guessing");
const shapes = [{ early: true, by_one: true }, { late: true, by_one: true }, { early: true, past_corner: true }, { reversed: true }];
const rows = [];
for (let i = 0; i < 20; i++) {

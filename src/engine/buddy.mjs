...
off_by_one_per_group	1	Every part of the fence is a little short. Look at how tall a post is.
...
counted_groups_as_group_size	1	Each part stops before the top of its post. Look at the sign again.
...
pack_unit_confusion	1	A pack is more than a plank. Count the planks in a pack.
pack_unit_confusion	2	Look at the fence and the cart. Count the planks in a pack, then the packs a part needs.
pack_unit_confusion	3	Count the planks in a pack. Then count how many packs make a part.
ambiguous	1	Tap a part you think is finished.
ambiguous	2	Tap the part you think is done. Look at the top of its post.
ambiguous	3	Tap a part you think is done. Does it reach the top of the post?

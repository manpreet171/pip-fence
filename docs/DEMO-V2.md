...
|---|---|---|---|
| 0:00–0:15 | **Cold open** | The Pip home page for two seconds (two games, stars, badges), then `/fence`, clean slate, the How-to-play sheet dismissed on camera. Header "3 parts. 4 planks in each part." Cart with twelve planks, goat outside, corn inside. | "This is Rung. A child is told three parts, four planks each, and given exactly twelve planks. The maths is the build. There is no question to answer." |

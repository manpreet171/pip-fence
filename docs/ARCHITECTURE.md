...
| `commit` | reason: left_plot or idle | Done, the last plank, or 45 s of silence |
...
| Two mistakes make the same fence | A probe: "Show me a part that looks finished." Her tap decides | id `ambiguous`, 25 of 162 fixtures |
